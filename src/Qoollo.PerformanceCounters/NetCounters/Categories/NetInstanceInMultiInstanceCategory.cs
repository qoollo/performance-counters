...
namespace Qoollo.PerformanceCounters.NetCounters.Categories
{
    ...
    /// </summary> 
    public class NetInstanceInMultiInstanceCategory : InstanceInMultiInstanceCategory
    {
        ...
        public NetInstanceInMultiInstanceCategory(NetMultiInstanceCategory parent, string instanceName)
        ...
        {
            var par = this.Parent as NetMultiInstanceCategory;
            if (par != null)
