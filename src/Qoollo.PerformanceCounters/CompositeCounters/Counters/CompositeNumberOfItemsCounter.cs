...
namespace Qoollo.PerformanceCounters.CompositeCounters.Counters
{
    ...
    /// </summary>
    public sealed class CompositeNumberOfItemsCounter : NumberOfItemsCounter
    {
        /// <summary>
        ...
        private class Descriptor : CompositeCounterDescriptor
        {
            ...
            {
                return new CompositeNumberOfItemsCounter(this.Name, this.Description, counters.Cast<NumberOfItemsCounter>());
            }
        }
        ...
        /// </summary>
        private readonly NumberOfItemsCounter[] _wrappedCounters;
        ...
        /// <param name="description">Описание счётчика</param>
        /// <param name="counters">Оборачиваемые счётчики</param>
        public CompositeNumberOfItemsCounter(string name, string description, IEnumerable<NumberOfItemsCounter> counters)
            : base(name, description)
        {
            ...
            if (_wrappedCounters.Length == 0)
                _wrappedCounters = new NumberOfItemsCounter[] { new NullCounters.Counters.NullNumberOfItemsCounter(name, description) };
        }
